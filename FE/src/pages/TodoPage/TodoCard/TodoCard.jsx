...
const TodoCard = ({handleDone, schedule, handleDeleteSchedule, handleSchedule}) => {
  return (
    <div className='todo-card' onClick={()=>{handleSchedule(schedule)}}>
      ...
      <div className='todo-card-btn-area'>
        <button onClick={(e)=>{handleDone(schedule._id, e)}} className='todo-done-btn'><i class="fa-solid fa-check"></i></button>
